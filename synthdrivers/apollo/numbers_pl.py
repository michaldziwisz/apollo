...
def dajPolaczoneNapisy(napisPierwszy, napisDrugi):
 napis=str(napisPierwszy)+str(napisDrugi)
 return napis
...
def dajPostacSlownaDziesiatki(znak):
 ...
 if znak=='1':
  napis='dziesięć'
 if znak=='2':
  napis=dajPolaczoneNapisy(dajPostacSlownaJednejCyfry(znak), 'dzieścia')
 if znak=='3':
  napis=dajPolaczoneNapisy(dajPostacSlownaJednejCyfry(znak), 'dzieści')
 if znak=='4':
  napis=dajPolaczoneNapisy(dajFragmentNapisu(dajPostacSlownaJednejCyfry(znak), 1, dajDlugoscNapisu(dajPostacSlownaJednejCyfry(znak))-1), 'dzieści')
 if (znak>='5') and (znak<='9'):
  napis=dajPolaczoneNapisy(dajPostacSlownaJednejCyfry(znak), 'dziesiąt')
 return napis

def dajPostacSlownaNascie(znak):
 napis=''
 if (znak=='1') or (znak=='4'):
  napis=dajPolaczoneNapisy(dajFragmentNapisu(dajPostacSlownaJednejCyfry(znak), 1, dajDlugoscNapisu(dajPostacSlownaJednejCyfry(znak))-1), 'naście')
 if (znak=='2') or (znak=='3') or (znak=='7') or (znak=='8'):
  napis=dajPolaczoneNapisy(dajPostacSlownaJednejCyfry(znak), 'naście')
 if znak=='6':
  napis='szesnaście'
 if (znak=='5') or (znak=='9'):
  napis=dajPolaczoneNapisy(dajFragmentNapisu(dajPostacSlownaJednejCyfry(znak), 1, dajDlugoscNapisu(dajPostacSlownaJednejCyfry(znak))-1), 'tnaście')
 return napis
...
def dajPostacSlownaSetki(znak):
 ...
 if znak=='2':
  napis='dwieście'
 if (znak=='3') or (znak=='4'):
  napis=dajPolaczoneNapisy(dajPostacSlownaJednejCyfry(znak), 'sta')
 if (znak>='5') and (znak<='9'):
  napis=dajPolaczoneNapisy(dajPostacSlownaJednejCyfry(znak), 'set')
 return napis
...
def dajOdmianeMiliona(znak):
 odmiana=''
 odmiana=dajOdmianeLiona('mi', znak)
 return odmiana

def dajOdmianeMiliarda(znak):
 odmiana=''
 odmiana=dajOdmianeLiarda('mi', znak)
 return odmiana

def dajOdmianeBiliona(znak):
 odmiana=''
 odmiana=dajOdmianeLiona('bi', znak)
 return odmiana

def dajOdmianeBiliarda(znak):
 odmiana=''
 odmiana=dajOdmianeLiarda('bi', znak)
 return odmiana

def dajOdmianeTryliona(znak):
 odmiana=''
 odmiana=dajOdmianeLiona('try', znak)
 return odmiana

def dajOdmianeTryliarda(znak):
 odmiana=''
 odmiana=dajOdmianeLiarda('try', znak)
 return odmiana

def dajOdmianeKwadryliona(znak):
 odmiana=''
 odmiana=dajOdmianeLiona('kwadry', znak)
 return odmiana

def dajOdmianeKwadryliarda(znak):
 odmiana=''
 odmiana=dajOdmianeLiarda('kwadry', znak)
 return odmiana

def dajOdmianeKwintyliona(znak):
 odmiana=''
 odmiana=dajOdmianeLiona('kwinty', znak)
 return odmiana

def dajOdmianeKwintyliarda(znak):
 odmiana=''
 odmiana=dajOdmianeLiarda('kwinty', znak)
 return odmiana

def dajOdmianeSekstyliona(znak):
 odmiana=''
 odmiana=dajOdmianeLiona('seksty', znak)
 return odmiana

def dajOdmianeSeptyliona(znak):
 odmiana=''
 odmiana=dajOdmianeLiona('septy', znak)
 return odmiana

def dajOdmianeOktyliona(znak):
 odmiana=''
 odmiana=dajOdmianeLiona('okty', znak)
 return odmiana

def dajOdmianeNonyliona(znak):
 odmiana=''
 odmiana=dajOdmianeLiona('nony', znak)
 return odmiana

def dajOdmianeDecyliona(znak):
 odmiana=''
 odmiana=dajOdmianeLiona('decy', znak)
 return odmiana

def dajOdmianeUndecyliona(znak):
 odmiana=''
 odmiana=dajOdmianeLiona('undecy', znak)
 return odmiana

def dajOdmianeDuodecyliona(znak):
 odmiana=''
 odmiana=dajOdmianeLiona('duodecy', znak)
 return odmiana

def dajOdmianeCentyliona(znak):
 odmiana=''
 odmiana=dajOdmianeLiona('centy', znak)
 return odmiana
